...
import { useSwapSettings, type SwapSettingsData } from '../hooks/useSwapSettings';
import './swapSettings.css';

interface SwapSettingsProps {
  settingsHook: ReturnType<typeof useSwapSettings>;
}

const SwapSettings: React.FC<SwapSettingsProps> = ({ settingsHook }) => {
  const {
    settings,
    isOpen,
    closeSettings,
